...
function(a) {
    ...
    function() {
        ...
        a.each(function() {
            ...
            var a, b, c, d, e;
            if (a = $(this).closest(".j-tgt-commond"), c = a.attr("data-url"), window.location.host.indexOf("task.") > -1 ? (b = $(this).closest(".task-com.chenls1997.spring.service-box-bd-list"), d = b.attr("data-id"), e = b.attr("data-loation")) : (b = $(this).closest("li"), d = b.attr("data-id"), e = b.attr("data-loation")), d) {
                var f = new Image;
