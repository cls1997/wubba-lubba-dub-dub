     		 ...
     		 <div class="ui-edit">
		           ...
		           <div class="fitem">  
		               ...
		               <input id='typeIds_combobox' class="easyui-combobox" 
							name="typeIds"
							data-options="
								url:'${__static__}/siteType/typeListJson.do',
								valueField:'id',
								textField:'name',
								multiple:true,
								panelHeight:'auto'">
...
<script type="text/javascript" src="${__static__}/js/commons/YDataGrid.js"></script>
<script type="text/javascript" src="${__static__}/js/ux/siteMain/siteMain.js"></script>
  </body>
</html>
